                ...
                LiteralArgumentBuilder<CommandSourceStack> cmd = literal("upnp")
                        ...
                        .executes(ctx -> {
                            if (!UPnP.isUPnPAvailable()) {
                                ctx.getSource().sendSuccess(new TextComponent("UPnP is not available on this network. If you are an admin please check the settings on your router/hub."), false);
                            } else {
